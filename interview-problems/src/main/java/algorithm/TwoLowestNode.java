...
public class TwoLowestNode {
    public static void main(String[] args) {
        ...
        TwoLowestNode twoLowestNode = new TwoLowestNode();
        TreeNode treeNode = twoLowestNode.lowestCommonAncestor(binaryRoot, binaryRoot1.left, binaryRoot1.right);
        ...
        TreeNode treeNode1 = twoLowestNode.lowestCommonAncestor2(normalRoot, normalRoot1.left, normalRoot1.right);
        System.out.println();
    }
