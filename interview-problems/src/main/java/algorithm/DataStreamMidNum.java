 ...
 * 思路：取排序好的中位数，并且偶数
 */
public class DataStreamMidNum {
    public static void main(String[] args) {
        DataStreamMidNum dataStreamMidNum = new DataStreamMidNum();
        for (int i = 1; i<= 3; i++) {
            dataStreamMidNum.Insert(i);
        }
        System.out.println(dataStreamMidNum.GetMedian());
    }
